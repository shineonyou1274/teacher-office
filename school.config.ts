...
// ══════════════════════════════════════════════════════════
//  학교 이름, 내 이름, 부서, 직원, 하루 순서까지 전부 여기 있습니다.
//  src/ 안의 파일은 건드리지 않아도 됩니다.
//
//  ⚠️ 규칙 2가지
//   1. 부서 id(research, design, ...)는 그냥 두시는 게 편합니다.
//      화면에 뜨는 건 name 이라, id는 두고 이름만 바꿔도 선생님 말로 나옵니다.
//      id까지 바꾸시려면 DEPARTMENTS 의 id · STAFF 의 deptId · DAY_PLAN 의 team
//      세 군데를 같이 바꾸세요. 빠뜨리면 화면 위에 어긋난 id가 뜹니다.
//   2. 부서 개수는 3~12개 사이로 하세요. 안 쓰는 부서는 지우시면 됩니다.
//      6개 이하면 교실이 한 줄로 서고 지도가 그만큼 짧아집니다.
//
...
export const SCHOOL = {
  ...
  title: "AI 교무실",
  /** 부제 한 줄 */
  /** 부제 한 줄 — 팀 수를 적으면 부서를 줄일 때 같이 고쳐야 합니다 */
  subtitle: "AI 팀이 수업을 나눠 준비하고, 선생님은 하루에 한 번만 결정합니다",
  /** 브라우저 탭 제목 */
  pageTitle: "AI 교무실",
  /** 창 하단 라벨 */
...
export const STAFF: StaffEntry[] = [
  ...
  { dept: "desk", rank: "member", name: "안리아", role: "보고 취합",
    ...
    thoughts: ["여러 팀 보고를 한 장으로 줄입니다.", "숫자 없는 보고는 다시 받아와요."] },
];
